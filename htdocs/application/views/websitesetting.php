               ...
               <div class="row">
                  ...
                  <div class="col-sm-6 col-md-4">
                     <div class="form-group">
                        ...
                        <input type="text" class="form-control" required="true" value="<?php echo output(isset($website_setting[0]['google_api_key'])?$website_setting[0]['google_api_key']:''); ?>" id="google_api_key" name="google_api_key" placeholder="Enter Address">
                     </div>
                  </div>
                  <div class="col-sm-6 col-md-4">
                     <div class="form-group">
