<footer class="main-footer">
   <strong>Devloped By Khushi</a>.</strong>
...
<script type="text/javascript"
   src="https://maps.google.com/maps/api/js?key=<?php echo output($data['google_api_key']); ?>&sensor=false&v=3.21.5a&libraries=drawing&signed_in=true&libraries=places,drawing"></script>
